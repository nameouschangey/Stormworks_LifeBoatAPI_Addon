...
LifeBoatAPI.CoroutineUtils.delay = function(numTicks)
    return LifeBoatAPI.Coroutine:start(numTicks)
end;
...
---@return LifeBoatAPI.Coroutine
LifeBoatAPI.CoroutineUtils.awaitAll = function(...)
    local coroutines = {...}
...
---@vararg LifeBoatAPI.Coroutine
---@return LifeBoatAPI.Coroutine
LifeBoatAPI.CoroutineUtils.awaitAny = function(...)
    local coroutines = {...}
